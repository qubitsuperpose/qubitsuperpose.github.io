...
문제3. 고전 컴퓨터에서 $f:\\{0,1\\}^2 →\\{0,1\\}$이 상수인지 균형인지 판별하려면 몇 번의 함수 평가가 필요합니까?
...
$\|\psi_0\rangle = \|0\rangle^{\otimes n}\|v\rangle$
...
$\|\psi_4\rangle = \left(\frac{1}{\sqrt{2}}(\|0\rangle + e^{2^{n-1}i\theta}\|1\rangle) \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2^{n-2}i\theta}\|1\rangle) \otimes ... \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2i\theta}\|1\rangle) \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{i\theta}\|1\rangle)\right)\|v\rangle$

이제 $\theta = 2\pi j$로 설정하겠습니다. 여기서 $j$는 비트스트링 $0.j_0j_1...j_{n-1}$이고 각 $j_i \in \\{0,1\\}$입니다. $j$를 이진법 대신 십진법으로 나타내면 $j = \frac{j_0}{2} + \frac{j_1}{4} + \frac{j_2}{8} + ... + \frac{j_{n-1}}{2^n}$ 입니다.

$\|\psi_4\rangle = \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i 2^{n-1}\left(\frac{j_0}{2} + \frac{j_1}{4} + \frac{j_2}{8} + ... + \frac{j_{n-1}}{2^n}\right)}\|1\rangle\right)$
$\otimes \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i 2^{n-2}\left(\frac{j_0}{2} + \frac{j_1}{4} + \frac{j_2}{8} + ... + \frac{j_{n-1}}{2^n}\right)}\|1\rangle\right)$
$\otimes ... \otimes \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i 2\left(\frac{j_0}{2} + \frac{j_1}{4} + \frac{j_2}{8} + ... + \frac{j_{n-1}}{2^n}\right)}\|1\rangle\right)$
$\otimes \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(\frac{j_0}{2} + \frac{j_1}{4} + \frac{j_2}{8} + ... + \frac{j_{n-1}}{2^n}\right)}\|1\rangle\right)\|v\rangle$

$= \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(2^{n-2}j_0 + ... + j_{n-2} + \frac{j_{n-1}}{2}\right)}\|1\rangle\right)$
$\otimes \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(2^{n-1}j_0 + ... + j_{n-3} + \frac{j_{n-2}}{2} + \frac{j_{n-1}}{4}\right)}\|1\rangle\right)$
$\otimes ... \otimes \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(j_0 + \frac{j_1}{2} + \frac{j_2}{4} + ... + \frac{j_{n-1}}{2^{n-1}}\right)}\|1\rangle\right)$
$\otimes \frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(\frac{j_0}{2} + \frac{j_1}{4} + \frac{j_2}{8} + ... + \frac{j_{n-1}}{2^n}\right)}|1\rangle\right)\|v\rangle$

상대 위상의 괄호 안에 있는 모든 정수는 $2\pi$의 배수이므로 제거할 수 있으며, 이는 상대 위상의 값에 영향을 주지 않습니다:

$= \frac{1}{\sqrt{2}}\left|0\rangle + e^{2\pi i\left(\frac{j_{n-1}}{2}\right)}\|1\rangle\right) \otimes$
$\frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(\frac{j_{n-2}}{2} + \frac{j_{n-1}}{4}\right)}\|1\rangle\right) \otimes ... \otimes$
$\frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(\frac{j_1}{2} + \frac{j_2}{4} + ... + \frac{j_{n-1}}{2^{n-1}}\right)}\|1\rangle\right) \otimes$
$\frac{1}{\sqrt{2}}\left(\|0\rangle + e^{2\pi i\left(\frac{j_0}{2} + \frac{j_1}{4} + ... + \frac{j_{n-1}}{2^n}\right)}\|1\rangle\right)$
...
$\|\psi_4\rangle = \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_{n-1}}{2})}\|1\rangle) \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_{n-2}}{2} + \frac{j_{n-1}}{4})}\|1\rangle) \otimes \ldots $ \
$\otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_1}{2} + \frac{j_2}{4} + \ldots + \frac{j_{n-1}}{2^{n-1}})}\|1\rangle) \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_0}{2} + \frac{j_1}{4} + \ldots + \frac{j_{n-1}}{2^n})}\|1\rangle)$

보시다시피, 이 상태는 $\|j\rangle$ 상태에 $QFT$를 적용한 것과 동일하므로, $\|\psi_4\rangle = QFT\|j\rangle$입니다. 따라서 $IQFT$를 적용하면 $\|j\rangle$ 상태를 얻게 됩니다:

$\|\psi_5\rangle = IQFT[\frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_{n-1}}{2})}\|1\rangle) \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_{n-2}}{2} + \frac{j_{n-1}}{4})}\|1\rangle) \otimes \ldots $ \ 
$\otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_0}{2} + \frac{j_1}{4} + \ldots + \frac{j_{n-1}}{2^{n-1}})}\|1\rangle) \otimes \frac{1}{\sqrt{2}}(\|0\rangle + e^{2\pi i(\frac{j_0}{2} + \frac{j_1}{4} + \ldots + \frac{j_{n-1}}{2^n})}\|1\rangle)]$

$= \|j_0j_1j_2\ldots j_{n-1}\rangle = \|j\rangle$
