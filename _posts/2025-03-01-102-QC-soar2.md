...
아래는 CNOT 게이트를 표현하는 방법으로, $\|\psi_{0}$을 타겟 큐비트로, $\|\psi_{1}$을 제어 큐비트 설정.
...
> 답: $\|\psi_{0}=\|00\rangle$ \
$\|\psi_{1}=\|01\rangle$ \
$\|\psi_{2}$ 에서 제어 큐비트(우측 큐비트)가 1이면 대상 큐비트(좌측 큐비트)에 아다마드 게이트를 적용한다. \
$\|\psi_{2}= H\|0\rangle\|1\rangle = \|+\rangle\|1\rangle = \frac{1}{\sqrt{2}}(\|0\rangle + \|1\rangle)\|1\rangle = \frac{1}{\sqrt{2}}(\|01\rangle + \|11\rangle)$
...
문제6. 상태 $\|\psi\rangle = \frac{1}{2}\|00\rangle + \frac{1}{2}\|11\rangle + \frac{1}{2}\|11\rangle + \frac{1}{2}\|11\rangle$, 첫번째 큐비트가 $\|0\rangle$ 로 측정될 확률은?
...
$\frac{\sqrt{3}}{2}\|00\rangle + \frac{1}{2}\|01\rangle = \|1\rangle \otimes (\frac{1}{2}\|0\rangle + \frac{\sqrt{3}}{2}\|1\rangle)$
...
문제3. 상태 $\|\psi\rangle = \frac{1}{\sqrt{2}}(\|0\rangle + \|1\rangle)$ 는 최대 얽힘인가? 부분 얽힘인가?
...
$\|1\rangle$는 $Z$ 게이트의 고유 벡터입니다. 왜냐하면 $Z\|1\rangle = -\|1\rangle = e^{i\theta}\|1\rangle$ :
...
문제2. 첫번째 큐비트는 대상으로 두번째 큐비트를 제어로 하여, 상태 $\|\psi_{0}\rangle = \|+\rangle \otimes \|-\rangle$ 에 제어된 Z를 적용한 후의 결과 상태는 어떻게 되나요?
> 답: $\|\psi_{1}\rangle = \frac{1}{\sqrt{2}}(\|0\rangle - \|1\rangle) \otimes \|1\rangle$ 상태가 되며, 대상의 Z 게이트의 고유값 −1은 제어 큐비트의 상대 위상으로 반동됩니다.
